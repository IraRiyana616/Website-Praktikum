...
import 'package:laksi/Pengguna/Mahasiswa/Asisten/Kelas/Komponen/Deskripsi/Tabel%20Modul/Form%20Edit%20Tabel%20Modul/form_edit_tabel.dart';
import 'package:url_launcher/url_launcher.dart';
import '../Modul/Komponen/Latihan/latihan_mhs.dart';

class TabelModulPraktikumAsisten extends StatefulWidget {
  final String kodeKelas;
  const TabelModulPraktikumAsisten({super.key, required this.kodeKelas});

  @override
  State<TabelModulPraktikumAsisten> createState() =>
      _TabelModulPraktikumAsistenState();
}

class _TabelModulPraktikumAsistenState
    extends State<TabelModulPraktikumAsisten> {
