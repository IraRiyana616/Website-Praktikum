...
class FormPengempulanLaporan extends StatefulWidget {
  const FormPengempulanLaporan({super.key});

  @override
  State<FormPengempulanLaporan> createState() => _FormPengempulanLaporanState();
}

class _FormPengempulanLaporanState extends State<FormPengempulanLaporan> {
  ...
  void updateRemainingWords(String text) {
    ...
    if (_remainingWords <= 0) {
      ...
      _deskripsiLaporanController.text =
          _deskripsiLaporanController.text.substring(0, 2500);
      _deskripsiLaporanController.selection = TextSelection.fromPosition(
          TextPosition(offset: _deskripsiLaporanController.text.length));
    }
  }
  ...
  void _saveLaporanForm() async {
    ...
    await tugasCollection.doc(nextDocumentId.toString()).set({
      ...
      'deskripsiLaporan': _deskripsiLaporanController.text,
    ...
    _deskripsiLaporanController.clear();
  }
