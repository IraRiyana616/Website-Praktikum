...
class TabelDataKelasMahasiswa extends StatefulWidget {
  final String kodeKelas;
  const TabelDataKelasMahasiswa({super.key, required this.kodeKelas});

  @override
  State<TabelDataKelasMahasiswa> createState() =>
      _TabelDataKelasMahasiswaState();
}
