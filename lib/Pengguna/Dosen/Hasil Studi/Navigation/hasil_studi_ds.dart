...
class HasilStudiDosenNav extends StatefulWidget {
  const HasilStudiDosenNav({super.key});

  @override
  State<HasilStudiDosenNav> createState() => _HasilStudiDosenNavState();
}

class _HasilStudiDosenNavState extends State<HasilStudiDosenNav> {
  Widget currentPage = const HasilStudiDosen();
  @override
