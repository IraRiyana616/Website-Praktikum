...
class AbsensiAdminNav extends StatefulWidget {
  const AbsensiAdminNav({super.key});

  @override
  State<AbsensiAdminNav> createState() => _AbsensiAdminNavState();
}

class _AbsensiAdminNavState extends State<AbsensiAdminNav> {
  Widget currentPage = const AbsensiAdmin();
  @override
