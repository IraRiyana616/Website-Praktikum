...
class TabelAbsensiPraktikanAdmin extends StatefulWidget {
  ...
  const TabelAbsensiPraktikanAdmin(
      {super.key, required this.kodeKelas, required this.mataKuliah});

  @override
  State<TabelAbsensiPraktikanAdmin> createState() =>
      _TabelAbsensiPraktikanAdminState();
}

class _TabelAbsensiPraktikanAdminState
    extends State<TabelAbsensiPraktikanAdmin> {
  //== List Tabel ==//
