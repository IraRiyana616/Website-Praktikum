...
import 'Form Edit Tabel/form_edit_admin.dart';

class TabelSilabusAdmin extends StatefulWidget {
  final String kodeKelas;
  const TabelSilabusAdmin({super.key, required this.kodeKelas});

  @override
  State<TabelSilabusAdmin> createState() => _TabelSilabusAdminState();
}

class _TabelSilabusAdminState extends State<TabelSilabusAdmin> {
