...
import '../Tabel/tabel_kelas_admin.dart';

class KelasAdmin extends StatefulWidget {
  const KelasAdmin({super.key});

  @override
  State<KelasAdmin> createState() => _KelasAdminState();
}

class _KelasAdminState extends State<KelasAdmin> {
