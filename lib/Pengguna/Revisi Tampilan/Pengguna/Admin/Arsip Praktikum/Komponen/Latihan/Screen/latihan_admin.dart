...
import '../../Tugas/Screen/tugas_admin.dart';
import '../Tabel/tabel_latihan_admin.dart';

class LatihanAdminScreen extends StatefulWidget {
  final String idkelas;
  final String mataKuliah;
  const LatihanAdminScreen(
      {super.key, required this.idkelas, required this.mataKuliah});

  @override
  State<LatihanAdminScreen> createState() => _LatihanAdminScreenState();
}

class _LatihanAdminScreenState extends State<LatihanAdminScreen> {
