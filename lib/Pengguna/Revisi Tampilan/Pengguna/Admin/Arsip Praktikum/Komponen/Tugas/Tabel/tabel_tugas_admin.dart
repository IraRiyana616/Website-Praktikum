...
class TabelTugasAdmin extends StatefulWidget {
  final String idkelas;
  final String mataKuliah;
  const TabelTugasAdmin(
      {super.key, required this.idkelas, required this.mataKuliah});

  @override
  State<TabelTugasAdmin> createState() => _TabelTugasAdminState();
}

class _TabelTugasAdminState extends State<TabelTugasAdmin> {
  //== Fungsi Controller ==//
...
void downloadFile(String idTA, String fileName, String judulModul) async {
  final ref =
      FirebaseStorage.instance.ref().child('tugas/$idTA/$judulModul/$fileName');
