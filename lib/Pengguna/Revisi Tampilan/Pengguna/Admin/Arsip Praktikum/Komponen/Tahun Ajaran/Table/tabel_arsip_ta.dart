...
class TabelArsipTahunAjaran extends StatefulWidget {
  final String mataKuliah;
  final String kode;
  const TabelArsipTahunAjaran(
      {super.key, required this.mataKuliah, required this.kode});

  @override
  State<TabelArsipTahunAjaran> createState() => _TabelArsipTahunAjaranState();
}

class _TabelArsipTahunAjaranState extends State<TabelArsipTahunAjaran> {
