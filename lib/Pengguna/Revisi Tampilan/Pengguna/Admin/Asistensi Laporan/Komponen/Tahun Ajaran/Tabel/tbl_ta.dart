...
class TabelTahunAjaranLaporan extends StatefulWidget {
  final String mataKuliah;
  final String kode;
  const TabelTahunAjaranLaporan(
      {super.key, required this.mataKuliah, required this.kode});

  @override
  State<TabelTahunAjaranLaporan> createState() =>
      _TabelTahunAjaranLaporanState();
}

class _TabelTahunAjaranLaporanState extends State<TabelTahunAjaranLaporan> {
