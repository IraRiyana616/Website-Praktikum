...
class AbsensiPraktikumNav extends StatefulWidget {
  const AbsensiPraktikumNav({super.key});

  @override
  State<AbsensiPraktikumNav> createState() => _AbsensiPraktikumNavState();
}

class _AbsensiPraktikumNavState extends State<AbsensiPraktikumNav> {
  late Widget currentPage;

  @override
  void initState() {
    super.initState();
    currentPage = const DataAbsensiPraktikum();
  }
