...
//== Fungsi Menyimpan Database ==//
  void saveData(BuildContext context) async {
    ...
    // == Validasi panjang kodeMatakuliah 9 huruf atau 9 angka == //
    ...
    try {
      // == Validasi kodeMatakuliah dan namaMatakuliah tidak boleh memasukkan lebih dari satu kali == //
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Kode matakuliah telah terdapat pada database'),
            backgroundColor: Colors.red,
          ),
        );
        return;
      ...
      final namaMatakuliahSnapshot = await FirebaseFirestore.instance
          .collection('dataMatakuliah')
          .where('matakuliah', isEqualTo: namaMatakuliah)
          .get();

      if (namaMatakuliahSnapshot.docs.isNotEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
      ...
      await FirebaseFirestore.instance.collection('dataMatakuliah').add({
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          //== Kode Matakuliah, Nama Matakuliah, Nama Dosen Pengampu 1 ==//
                          Column(
                            children: [
                              SizedBox(
                                height: 400.0,
                          ...
                          //== NIP Dosen Pengampu 1, Nama Dosen Pengampu dan NIP Dosen Pengampu 2
                          Column(
                            children: [
                              SizedBox(
                                height: 400.0,
