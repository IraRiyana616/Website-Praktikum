...
class EditSilabusPraktikum extends StatefulWidget {
  final String idkelas;
  final String modul;
  final String kodeMatakuliah;
  final String matakuliah;
  final String idModul;
  const EditSilabusPraktikum(
      {super.key,
  ...
  @override
  State<EditSilabusPraktikum> createState() => _EditSilabusPraktikumState();
}

class _EditSilabusPraktikumState extends State<EditSilabusPraktikum> {
  //== Fungsi Cntroller ==//
