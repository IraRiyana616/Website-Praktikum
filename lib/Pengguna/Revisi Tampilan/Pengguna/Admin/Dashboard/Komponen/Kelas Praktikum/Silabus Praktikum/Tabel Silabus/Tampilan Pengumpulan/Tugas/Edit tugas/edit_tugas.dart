...
class EditPengumpulanTugas extends StatefulWidget {
  final String idkelas;
  final String modul;
  const EditPengumpulanTugas(
      {super.key, required this.idkelas, required this.modul});

  @override
  State<EditPengumpulanTugas> createState() => _EditPengumpulanTugasState();
}

class _EditPengumpulanTugasState extends State<EditPengumpulanTugas> {
