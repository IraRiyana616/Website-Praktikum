...
class EditPengumpulanLatihan extends StatefulWidget {
  final String idkelas;
  final String modul;
  const EditPengumpulanLatihan(
      {super.key, required this.idkelas, required this.modul});

  @override
  State<EditPengumpulanLatihan> createState() => _EditPengumpulanLatihanState();
}

class _EditPengumpulanLatihanState extends State<EditPengumpulanLatihan> {
