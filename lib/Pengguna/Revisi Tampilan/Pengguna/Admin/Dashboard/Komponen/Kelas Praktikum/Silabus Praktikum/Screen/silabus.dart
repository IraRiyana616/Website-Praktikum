...
import '../Tabel Silabus/tabel_silabus.dart';

class SilabusScreen extends StatefulWidget {
  ...
  @override
  State<SilabusScreen> createState() => _SilabusScreenState();
}

class _SilabusScreenState extends State<SilabusScreen> {
  @override
