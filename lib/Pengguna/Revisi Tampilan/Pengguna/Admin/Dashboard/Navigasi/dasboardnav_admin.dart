...
class DashboardNavigasiAdmin extends StatefulWidget {
  const DashboardNavigasiAdmin({super.key});

  @override
  State<DashboardNavigasiAdmin> createState() => _DashboardNavigasiAdminState();
}

class _DashboardNavigasiAdminState extends State<DashboardNavigasiAdmin> {
  late Widget currentPage;

  @override
  void initState() {
    super.initState();
    currentPage = const DashboardAdmin();
  }
