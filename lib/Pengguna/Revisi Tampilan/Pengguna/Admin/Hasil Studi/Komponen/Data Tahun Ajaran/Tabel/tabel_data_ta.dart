...
import '../../Nilai Harian/nilai_harian.dart';

class TabelTAHasilStudi extends StatefulWidget {
  final String mataKuliah;
  final String kode;
  const TabelTAHasilStudi(
      {super.key, required this.kode, required this.mataKuliah});

  @override
  State<TabelTAHasilStudi> createState() => _TabelTAHasilStudiState();
}

class _TabelTAHasilStudiState extends State<TabelTAHasilStudi> {
