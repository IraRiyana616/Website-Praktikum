...
import '../Tabel/tabel_absensi_praktikum_asisten.dart';

class AbsensiPraktikumAsistenScreen extends StatefulWidget {
  const AbsensiPraktikumAsistenScreen({super.key});

  @override
  State<AbsensiPraktikumAsistenScreen> createState() =>
      _AbsensiPraktikumAsistenScreenState();
}

class _AbsensiPraktikumAsistenScreenState
    extends State<AbsensiPraktikumAsistenScreen> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    color: Colors.white,
                    child: const TabelAbsensiPraktikumAsisten(),
                  ),
                ),
              ],
            ),
