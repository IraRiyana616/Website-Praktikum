...
import '../../../../../Admin/Absensi/Komponen/Akses Absensi/Tabel/tabel_akses_absensi.dart';
import '../../Navigasi/absensinav_asisten.dart';
import '../Praktikan/absensi_praktikan.dart';

class AksesAbsensiAsisten extends StatefulWidget {
  final String idkelas;
  final String matkul;
  final String kode;
  const AksesAbsensiAsisten(
      {super.key,
  ...
  @override
  State<AksesAbsensiAsisten> createState() => _AksesAbsensiAsistenState();
}

class _AksesAbsensiAsistenState extends State<AksesAbsensiAsisten> {
