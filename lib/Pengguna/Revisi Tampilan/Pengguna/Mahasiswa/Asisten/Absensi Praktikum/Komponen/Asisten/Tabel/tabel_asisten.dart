...
class TabelAbsensiAsistenScreen extends StatefulWidget {
  final String kodeKelas;
  final String mataKuliah;
  const TabelAbsensiAsistenScreen(
      {super.key, required this.kodeKelas, required this.mataKuliah});

  @override
  State<TabelAbsensiAsistenScreen> createState() =>
      _TabelAbsensiAsistenScreenState();
}

class _TabelAbsensiAsistenScreenState extends State<TabelAbsensiAsistenScreen> {
