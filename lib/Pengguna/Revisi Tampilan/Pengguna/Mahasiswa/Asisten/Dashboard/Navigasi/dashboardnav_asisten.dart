...
import '../Screen/dashboard_asisten.dart';

class DasboardAsistenNavigasi extends StatefulWidget {
  const DasboardAsistenNavigasi({super.key});

  @override
  State<DasboardAsistenNavigasi> createState() =>
      _DasboardAsistenNavigasiState();
}

class _DasboardAsistenNavigasiState extends State<DasboardAsistenNavigasi> {
  late Widget currentPage;
  String currentRole = 'Asisten'; // Menyimpan status dropdown yang dipilih
