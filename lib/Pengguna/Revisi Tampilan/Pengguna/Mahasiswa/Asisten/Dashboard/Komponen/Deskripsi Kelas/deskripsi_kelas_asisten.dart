...
import 'Edit Deskripsi/edit.dart';
import 'Tabel Silabus.dart/tabel_silabus.dart';

class DeskripsiKelasAsisten extends StatefulWidget {
  final String idkelas;
  final String mataKuliah;
  final String kode;
  const DeskripsiKelasAsisten(
      {super.key,
  ...
  @override
  State<DeskripsiKelasAsisten> createState() => _DeskripsiKelasAsistenState();
}

class _DeskripsiKelasAsistenState extends State<DeskripsiKelasAsisten> {
  @override
