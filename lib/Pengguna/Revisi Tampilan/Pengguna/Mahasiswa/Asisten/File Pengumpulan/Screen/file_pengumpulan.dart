...
import '../Tabel/tabel_file_pengumpulan.dart';

class FilePengumpulanScreen extends StatefulWidget {
  const FilePengumpulanScreen({super.key});

  @override
  State<FilePengumpulanScreen> createState() => _FilePengumpulanScreenState();
}

class _FilePengumpulanScreenState extends State<FilePengumpulanScreen> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    color: Colors.white,
                    child: const TabelFilePengumpulanAsisten(),
                  ),
                ),
              ],
            ),
