...
import '../Nilai Harian/nilai_akhir_asisten.dart';

class NilaiAkhirAsistenScreen extends StatefulWidget {
  final String kodeKelas;
  final String matakuliah;
  const NilaiAkhirAsistenScreen(
      {super.key, required this.kodeKelas, required this.matakuliah});

  @override
  State<NilaiAkhirAsistenScreen> createState() =>
      _NilaiAkhirAsistenScreenState();
}
