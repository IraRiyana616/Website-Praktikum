...
import '../Tabel/tabel_hasil_studi_asisten.dart';

class HasilStudiAsistensi extends StatefulWidget {
  const HasilStudiAsistensi({super.key});

  @override
  State<HasilStudiAsistensi> createState() => _HasilStudiAsistensiState();
}

class _HasilStudiAsistensiState extends State<HasilStudiAsistensi> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    color: Colors.white,
                    child: const TabelHasilStudiScreen(),
                  ),
                ),
              ],
            ),
