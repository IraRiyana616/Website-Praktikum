...
import '../Screen/dashboard_praktikan.dart';

class DashboardNavigasiPraktikan extends StatefulWidget {
  const DashboardNavigasiPraktikan({super.key});

  @override
  State<DashboardNavigasiPraktikan> createState() =>
      _DashboardNavigasiPraktikanState();
}

class _DashboardNavigasiPraktikanState
    extends State<DashboardNavigasiPraktikan> {
  late Widget currentPage;
  String currentRole = 'Praktikan'; // Menyimpan status dropdown yang dipilih
