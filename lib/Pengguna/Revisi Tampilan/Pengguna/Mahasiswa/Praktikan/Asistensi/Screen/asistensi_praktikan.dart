...
import '../Tabel/tabel_asistensi_praktikan.dart';

class AsistensiPraktikanScreen extends StatefulWidget {
  const AsistensiPraktikanScreen({super.key});

  @override
  State<AsistensiPraktikanScreen> createState() =>
      _AsistensiPraktikanScreenState();
}

class _AsistensiPraktikanScreenState extends State<AsistensiPraktikanScreen> {
