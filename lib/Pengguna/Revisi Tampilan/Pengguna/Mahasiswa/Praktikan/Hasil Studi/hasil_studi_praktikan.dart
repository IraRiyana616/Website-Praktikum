...
import '../../../../../Mahasiswa/Praktikan/Hasil Studi/Tabel/tabel_transkrip.dart';

class HasilStudiPraktikan extends StatefulWidget {
  const HasilStudiPraktikan({super.key});

  @override
  State<HasilStudiPraktikan> createState() => _HasilStudiPraktikanState();
}

class _HasilStudiPraktikanState extends State<HasilStudiPraktikan> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    color: Colors.white,
                    child: const TabelTranskripNilai(),
                  ),
                ),
              ],
            ),
