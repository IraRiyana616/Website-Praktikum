...
class AbsensiPraktikumScreen extends StatefulWidget {
  const AbsensiPraktikumScreen({super.key});

  @override
  State<AbsensiPraktikumScreen> createState() => _AbsensiPraktikumScreenState();
}

class _AbsensiPraktikumScreenState extends State<AbsensiPraktikumScreen> {
