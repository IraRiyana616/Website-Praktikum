...
import '../Tabel/tabel_file_pengumpulan_dosen.dart';

class FilePengumpulanScreenDosen extends StatefulWidget {
  const FilePengumpulanScreenDosen({super.key});

  @override
  State<FilePengumpulanScreenDosen> createState() =>
      _FilePengumpulanScreenDosenState();
}

class _FilePengumpulanScreenDosenState
    extends State<FilePengumpulanScreenDosen> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    color: Colors.white,
                    child: const TabelFilePengumpulanDosen(),
                  ),
                ),
              ],
            ),
