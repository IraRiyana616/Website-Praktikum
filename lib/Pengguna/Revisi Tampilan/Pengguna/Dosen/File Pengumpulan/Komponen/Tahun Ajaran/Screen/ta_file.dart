...
import '../Tabel/tbl_ta_file.dart';

class TahunAjaranFile extends StatefulWidget {
  final String mataKuliah;
  final String kode;
  const TahunAjaranFile(
      {super.key, required this.mataKuliah, required this.kode});

  @override
  State<TahunAjaranFile> createState() => _TahunAjaranFileState();
}

class _TahunAjaranFileState extends State<TahunAjaranFile> {
