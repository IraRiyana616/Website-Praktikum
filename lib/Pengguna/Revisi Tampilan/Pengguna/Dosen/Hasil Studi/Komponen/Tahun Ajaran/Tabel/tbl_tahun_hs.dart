...
class TabelTAHasil extends StatefulWidget {
  final String kode;
  final String matkul;
  const TabelTAHasil({super.key, required this.kode, required this.matkul});

  @override
  State<TabelTAHasil> createState() => _TabelTAHasilState();
}

class _TabelTAHasilState extends State<TabelTAHasil> {
