...
import '../Komponen/Tahun Ajaran/Screen/ta_hasil_studi.dart';

class TabelHasilStudiDosen extends StatefulWidget {
  const TabelHasilStudiDosen({super.key});

  @override
  State<TabelHasilStudiDosen> createState() => _TabelHasilStudiDosenState();
}
