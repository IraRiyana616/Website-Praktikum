...
import '../Tabel/tabel_hasil_studi_dosen.dart';

class HasilStudiScreenDosen extends StatefulWidget {
  const HasilStudiScreenDosen({super.key});

  @override
  State<HasilStudiScreenDosen> createState() => _HasilStudiScreenDosenState();
}

class _HasilStudiScreenDosenState extends State<HasilStudiScreenDosen> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    color: Colors.white,
                    child: const TabelHasilStudiDosen(),
                  ),
                ),
              ],
            ),
