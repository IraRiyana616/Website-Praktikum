...
import '../Tabel/tbl_ta_asistensi.dart';

class TahunAjaranAsistensi extends StatefulWidget {
  final String kode;
  final String matakuliah;
  const TahunAjaranAsistensi(
      {super.key, required this.kode, required this.matakuliah});

  @override
  State<TahunAjaranAsistensi> createState() => _TahunAjaranAsistensiState();
}

class _TahunAjaranAsistensiState extends State<TahunAjaranAsistensi> {
