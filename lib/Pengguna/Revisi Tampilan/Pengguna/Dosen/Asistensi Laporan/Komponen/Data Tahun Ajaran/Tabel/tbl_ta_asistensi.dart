...
class TabelTAAsistensi extends StatefulWidget {
  final String kode;
  final String matakuliah;
  const TabelTAAsistensi(
      {super.key, required this.kode, required this.matakuliah});

  @override
  State<TabelTAAsistensi> createState() => _TabelTAAsistensiState();
}

class _TabelTAAsistensiState extends State<TabelTAAsistensi> {
