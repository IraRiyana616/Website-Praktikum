...
import '../Screen/asisten_laporan_dosen.dart';

class AsistensiLaporanNavigasiDosen extends StatefulWidget {
  const AsistensiLaporanNavigasiDosen({super.key});

  @override
  State<AsistensiLaporanNavigasiDosen> createState() =>
      _AsistensiLaporanNavigasiDosenState();
}

class _AsistensiLaporanNavigasiDosenState
    extends State<AsistensiLaporanNavigasiDosen> {
  late Widget currentPage;

  @override
  void initState() {
    super.initState();
    currentPage = const AsistensiLaporanDosen();
  }
