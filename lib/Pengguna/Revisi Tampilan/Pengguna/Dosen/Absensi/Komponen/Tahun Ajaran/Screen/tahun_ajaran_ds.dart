...
import '../Tabel/tabel_ta_ds.dart';

class TahunAjaranAbsensi extends StatefulWidget {
  final String mataKuliah;
  final String kode;
  const TahunAjaranAbsensi(
      {super.key, required this.mataKuliah, required this.kode});

  @override
  State<TahunAjaranAbsensi> createState() => _TahunAjaranAbsensiState();
}

class _TahunAjaranAbsensiState extends State<TahunAjaranAbsensi> {
