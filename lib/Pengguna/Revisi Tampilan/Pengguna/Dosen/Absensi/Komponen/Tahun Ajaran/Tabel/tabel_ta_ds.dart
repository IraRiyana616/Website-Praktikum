...
class TabelTahunAjaranAbsensi extends StatefulWidget {
  final String kode;
  final String matkul;
  const TabelTahunAjaranAbsensi(
      {super.key, required this.kode, required this.matkul});

  @override
  State<TabelTahunAjaranAbsensi> createState() =>
      _TabelTahunAjaranAbsensiState();
}

class _TabelTahunAjaranAbsensiState extends State<TabelTahunAjaranAbsensi> {
