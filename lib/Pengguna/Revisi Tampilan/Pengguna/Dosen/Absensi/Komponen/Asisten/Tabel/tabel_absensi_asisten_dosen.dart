...
class TabelAbsensiAsistenScreenDosen extends StatefulWidget {
  final String kodeAsisten;
  final String mataKuliah;
  const TabelAbsensiAsistenScreenDosen(
      {super.key, required this.kodeAsisten, required this.mataKuliah});

  @override
  State<TabelAbsensiAsistenScreenDosen> createState() =>
      _TabelAbsensiAsistenScreenDosenState();
}

class _TabelAbsensiAsistenScreenDosenState
    extends State<TabelAbsensiAsistenScreenDosen> {
