...
import '../Komponen/Praktikan/Screen/absensi_praktikan_dosen.dart';

class TabelAbsensiScreenDosen extends StatefulWidget {
  const TabelAbsensiScreenDosen({super.key});

  @override
  State<TabelAbsensiScreenDosen> createState() =>
      _TabelAbsensiScreenDosenState();
}

class _TabelAbsensiScreenDosenState extends State<TabelAbsensiScreenDosen> {
