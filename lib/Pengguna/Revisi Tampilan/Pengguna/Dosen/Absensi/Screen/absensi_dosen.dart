...
import '../Tabel/tabel_absensi_dosen.dart';

class AbsensiScreenDosen extends StatefulWidget {
  const AbsensiScreenDosen({super.key});

  @override
  State<AbsensiScreenDosen> createState() => _AbsensiScreenDosenState();
}

class _AbsensiScreenDosenState extends State<AbsensiScreenDosen> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    color: Colors.white,
                    child: const TabelAbsensiScreenDosen(),
                  ),
                ),
              ],
            ),
