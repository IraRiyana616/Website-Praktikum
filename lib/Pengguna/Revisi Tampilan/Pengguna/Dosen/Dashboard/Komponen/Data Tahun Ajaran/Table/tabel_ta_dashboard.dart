...
class TabelTADashboard extends StatefulWidget {
  final String kode;
  final String matkul;
  const TabelTADashboard({super.key, required this.kode, required this.matkul});

  @override
  State<TabelTADashboard> createState() => _TabelTADashboardState();
}

class _TabelTADashboardState extends State<TabelTADashboard> {
