...
import '../Table/tabel_ta_dashboard.dart';

class TAKelasPraktikum extends StatefulWidget {
  final String kode;
  final String matakuliah;
  const TAKelasPraktikum(
      {super.key, required this.kode, required this.matakuliah});

  @override
  State<TAKelasPraktikum> createState() => _TAKelasPraktikumState();
}

class _TAKelasPraktikumState extends State<TAKelasPraktikum> {
