...
class SilabusPraktikumDosen extends StatefulWidget {
  final String idkelas;
  final String kodeMatakuliah;
  final String mataKuliah;
  const SilabusPraktikumDosen(
      {super.key,
  ...
  @override
  State<SilabusPraktikumDosen> createState() => _SilabusPraktikumDosenState();
}

class _SilabusPraktikumDosenState extends State<SilabusPraktikumDosen> {
  //== List Data Tabel ==//
